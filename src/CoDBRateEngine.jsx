    ...
    <div style={{ background: C.black, color: C.white, minHeight: "100vh", fontFamily: "'Bebas Neue', sans-serif" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 600, color: C.white30, letterSpacing: "0.2em", marginTop: 3 }}>
                CoDB RATE ENGINE
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div>
              <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 9, fontWeight: 500, color: C.white15, letterSpacing: "0.15em", textAlign: "right" }}>POWERED BY</div>
          ...
          <div style={{ animation: "fadeUp 0.4s ease" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
                <div>
                  ...
                  <div style={{
                    fontFamily: "'Bebas Neue', sans-serif", fontSize: 64, color: C.white,
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 28px" }}>
                  {[
                    ...
                    <div key={k.label}>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", color: C.white30 }}>{k.label}</div>
                      <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 20, fontWeight: 700, color: C.white90 }}>{k.value}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 28 }}>
              {[
                ...
                <div key={i} className="jcard" style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", color: C.white30 }}>{c.label}</div>
                  {c.delta !== null ? (
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 24, fontWeight: 700, color: c.delta > 0 ? C.redBright : C.green, margin: "4px 0" }}>
                      {c.delta > 0 ? "+" : ""}{c.delta.toFixed(1)}%
                    </div>
                  ) : (
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 24, fontWeight: 700, color: C.white, margin: "4px 0" }}>{c.ref}</div>
                  )}
                  {c.delta !== null && <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: C.white30 }}>{c.ref}</div>}
                </div>
              ))}
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ padding: "20px 24px", textAlign: "center" }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>WITHOUT LAYER 1</div>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 32, fontWeight: 700, color: C.white30, textDecoration: "line-through", textDecorationColor: C.red, margin: "4px 0" }}>{fmt(rateWithoutLayer1)}</div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white15 }}>Your old rate — underpriced</div>
                </div>
                ...
                <div style={{ padding: "20px 24px", textAlign: "center", background: C.redSubtle }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.red }}>WITH LAYER 1</div>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 32, fontWeight: 700, color: C.white, margin: "4px 0" }}>{fmt(trueHourlyRate)}</div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white50 }}>Your real rate — accurate</div>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 20 }}>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>{s.label}</div>
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, fontWeight: 700, color: C.red, margin: "4px 0" }}>{s.value}</div>
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white15 }}>{s.sub}</div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white15, marginTop: 4, fontStyle: "italic" }}>{item.note}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 14 }}>
                  <div>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>MONTHLY REVENUE TARGET</div>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: netAfterCosts > 0 ? C.green : C.redBright }}>NET AFTER ALL COSTS</div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6 }}>
                  <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.red }}>
                    Costs: {fmtD(totalCosts)} ({revenue.monthlyTarget > 0 ? (totalCosts / revenue.monthlyTarget * 100).toFixed(0) : '0'}%)
                  </span>
                  <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: netAfterCosts > 0 ? C.green : C.redBright }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, marginBottom: 12 }}>JOBS REQUIRED</div>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>CAPACITY CHECK</span>
                    <span style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>Recurring revenue that reduces pressure on one-time sales</div>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>of target</div>
                  </div>
                  <div style={{ width: 1, height: 30, background: C.white08 }} />
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>annualized</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: C.red, marginBottom: 18 }}>
                  ...
                  {[
                    ...
                    <div key={item.key} style={{ background: item.bg, borderRadius: 6, padding: "14px", border: `1px solid ${item.border}` }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
                        ...
                        <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: item.color, letterSpacing: "0.1em" }}>{item.label}</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div>
                          <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>@ {fmtD(item.ticket)} avg</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8, marginBottom: 10 }}>
                  {[
                    ...
                    <div key={d.label} style={{ background: d.bg, borderRadius: 6, padding: "12px", border: `1px solid ${d.border}` }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                        <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: d.color }}>{d.label}</span>
                        <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 18, color: C.white }}>{d.calls}</span>
                      </div>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginBottom: 4 }}>Svc {d.svc} · Inst {d.inst}</div>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white30, marginBottom: 6 }}>TOTAL</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16 }}>
                  <div style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white50 }}>ALL SERVICE</div>
                  ...
                  <div style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white50 }}>ALL INSTALLS</div>
                ...
                <div style={{
                  ...
                  {[
                    ...
                    <div key={s.label} style={{ textAlign: "center" }}>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white15 }}>{s.label}</div>
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: C.white30, marginBottom: 14 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "130px 1fr 1fr 1fr 1fr 1fr 1fr", gap: 0, marginBottom: 2 }}>
                  ...
                  <div style={{ gridColumn: "span 3", textAlign: "center", padding: "6px 0", borderBottom: `2px solid ${C.red}` }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.red }}>PROJECTED (FROM BOARD)</span>
                  </div>
                  <div style={{ gridColumn: "span 3", textAlign: "center", padding: "6px 0", borderBottom: `2px solid ${C.white15}` }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>TARGET (EDITABLE)</span>
                  </div>
                </div>
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ padding: "10px 0", display: "flex", alignItems: "center" }}>
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", color: row.color }}>{row.label}</span>
                    </div>
                    {row.proj.map((val, j) => {
              ...
              <div style={{
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: C.white30, marginBottom: 16 }}>
                ...
                <div style={{ position: "relative", marginBottom: 20 }}>
                  <div style={{ display: "flex", height: 48, borderRadius: 6, overflow: "hidden" }}>
                    <div style={{
                      ...
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: C.white, letterSpacing: "0.08em" }}>
                        COVERING COSTS
                      </span>
                    </div>
                    {profitDays > 0 && <div style={{
                      ...
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: C.black, letterSpacing: "0.08em" }}>
                        PROFIT ZONE
                      </span>
                    </div>}
                  </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>BREAKEVEN DAY</div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>of the month</div>
                  </div>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>PROFIT DAYS</div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>work days left</div>
                  </div>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>PROJECTED PROFIT</div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>{projectedMargin.toFixed(1)}% margin</div>
                  </div>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>PROJECTED REVENUE</div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>at this pace</div>
                  </div>
                </div>
              </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
                ...
                <button className="jbtn" onClick={resetWhatIf} style={{
                  ...
                  background: "transparent", color: C.white50, fontSize: 11, cursor: "pointer",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 24 }}>
                {[
                  ...
                  <div key={s.key} style={{
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, marginBottom: 8 }}>{s.label}</div>
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "140px 1fr 1fr 1fr", background: C.white04 }}>
                  ...
                  <div style={{ padding: "10px 14px", textAlign: "center", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>CURRENT</div>
                  <div style={{ padding: "10px 14px", textAlign: "center", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.amber }}>WHAT-IF</div>
                  <div style={{ padding: "10px 14px", textAlign: "center", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>IMPACT</div>
                </div>
                {/* Rows */}
                {[
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <div style={{ padding: "12px 14px", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", color: C.white70 }}>{row.label}</div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
                ...
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white15 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 20 }}>
                <div style={{ background: C.white02, borderRadius: 6, padding: "14px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>NET PROFIT</div>
                  <div style={{
                  ...
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>target: {plData.profitBm[0]}-{plData.profitBm[1]}%</div>
                  <div style={{
                    fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, marginTop: 4,
                ...
                <div style={{ background: C.white02, borderRadius: 6, padding: "14px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30 }}>TOTAL COST %</div>
                  ...
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>of revenue</div>
                </div>
                <div style={{ background: C.greenSub, borderRadius: 6, padding: "14px", textAlign: "center", border: `1px solid rgba(34,197,94,0.12)` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.green }}>IN RANGE</div>
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 36, color: C.green, lineHeight: 1, margin: "4px 0" }}>{plData.okCount}</div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>categories</div>
                </div>
                <div style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: (plData.overCount + plData.underCount) > 0 ? C.redBright : C.green }}>OUT OF RANGE</div>
                  ...
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30 }}>{plData.overCount} over · {plData.underCount} under</div>
                </div>
              </div>
              ...
              <div style={{ borderRadius: 6, overflow: "hidden", border: `1px solid ${C.white04}` }}>
                <div style={{ display: "grid", gridTemplateColumns: "160px 1fr 70px 90px 70px", background: C.white04, padding: "10px 14px" }}>
                  {["CATEGORY", "% OF REVENUE", "ACTUAL", "BENCHMARK", "STATUS"].map(h => (
                    <div key={h} style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, textAlign: h === "STATUS" ? "center" : "left" }}>{h}</div>
                  ))}
                </div>
                {plData.items.map((item, i) => {
                  ...
                  return (
                    <div key={item.key} className="jrow" style={{
                      ...
                      <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, fontWeight: 600, color: item.layer ? (item.layer === 1 ? C.red : C.amber) : C.white70 }}>{item.label}</span>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 600, color: statusColor }}>{item.pctOfRev.toFixed(1)}%</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white30 }}>{item.low}-{item.high}%</span>
                      <div style={{ textAlign: "center" }}>
                        <span style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white30 }}>{plData.profitBm[0]}-{plData.profitBm[1]}%</span>
                  <div style={{ textAlign: "center" }}>
                    <span style={{
                      fontFamily: "'Barlow Condensed', sans-serif", fontSize: 8, fontWeight: 700,
                      padding: "2px 6px", borderRadius: 2,
            ...
            <div style={{ background: C.blackCard, border: `1px solid ${C.white08}`, borderRadius: 8, padding: 24, marginBottom: 28, position: "relative" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 16 }}>
                {[
                  ...
                  <div key={a.key} style={{ background: C.white02, borderRadius: 6, padding: "14px", border: `1px solid ${C.white04}`, textAlign: "center" }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.12em", color: a.color }}>{a.label}</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                <div style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white30 }}>TOTAL A/R</div>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 20, fontWeight: 700, color: C.white }}>{fmtD(totalReceivables)}</div>
                </div>
                <div style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white30 }}>AT RISK (60d+)</div>
                ...
                <div style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white30 }}>COLLECTIBLE %</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10, marginBottom: 16 }}>
                {[
                  ...
                  <div key={m.key} style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: m.color }}>{m.label}</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
                {[
                  ...
                  <div key={i} style={{ background: C.white02, borderRadius: 6, padding: "12px", textAlign: "center", border: `1px solid ${C.white04}` }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.1em", color: C.white30 }}>{s.label}</div>
            ...
            <div style={{ background: C.blackCard, border: `1px solid ${activeAlerts.length > 0 ? "rgba(239,68,68,0.2)" : C.white08}`, borderRadius: 8, padding: 24, marginBottom: 28, position: "relative" }}>
                  ...
                  {activeAlerts.map((a, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30, marginLeft: 8 }}>threshold: {a.threshold}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* Threshold Settings */}
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, marginBottom: 10 }}>ALERT THRESHOLDS — EDITABLE</div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 }}>
                {[
                  ...
                  <div key={t.key} style={{ background: C.white02, borderRadius: 4, padding: "10px 12px", border: `1px solid ${C.white04}` }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 8, fontWeight: 700, letterSpacing: "0.1em", color: C.white30, marginBottom: 4 }}>{t.label}</div>
                    <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                      {t.prefix && <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white30 }}>{t.prefix}</span>}
                      ...
                      {t.suffix && <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white30 }}>{t.suffix}</span>}
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{
                  ...
                  {[
                    ...
                    <div key={d.label} style={{ textAlign: "center", padding: "16px", background: d.bg, borderRadius: 6 }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 4 }}>
                        ...
                        <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: d.color, letterSpacing: "0.1em" }}>{d.label}</span>
                      </div>
                      <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 34, color: C.white, lineHeight: 1 }}>{fmt(d.rate)}</div>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginTop: 4 }}>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: C.white30 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: 4 }}>
                  {seasonalRates.map(m => (
                    <div key={m.month} style={{ textAlign: "center" }}>
                      ...
                      <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 8, color: C.white08 }}>{m.mult}%</div>
                    </div>
                  ))}
                </div>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 12, color: C.white30, marginTop: 12, fontStyle: "italic", textAlign: "center" }}>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4 }}>
                  <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.red }}>Acquisition cost</span>
                  <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.green }}>Lifetime profit</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: C.amber }}>CULTURE & TRAINING INVESTMENT</div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30 }}>Team events + certifications — the costs that retain your techs</div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, fontWeight: 700, color: C.white }}>{fmtD(layer3Total)}/mo</div>
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white15 }}>monthly</div>
                  </div>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white15 }}>annual</div>
                  </div>
                  <div style={{ width: 1, height: 28, background: C.white08 }} />
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white15 }}>per tech/mo</div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {dataAlerts.map((a, i) => {
                    ...
                    return (
                      <div key={i} style={{
                        ...
                        <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: col }}>{a.type.toUpperCase()}</span>
        ...
        {activeTab === "agent" && (
          <div style={{ animation: "fadeUp 0.4s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
              ...
              <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, color: C.white30, letterSpacing: "0.1em" }}>POWERED BY CLAUDE</span>
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, marginBottom: 8 }}>ASK THE AGENT ANYTHING</div>
            ...
            {(agentAnalysis || agentLoading) && (
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                  ...
                  <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: C.red }}>
            ...
            {agentHistory.length > 0 && (
              <div>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: C.white30, marginBottom: 10 }}>AGENT HISTORY</div>
                {agentHistory.map((entry, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white15 }}>{entry.time}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={{ animation: "fadeUp 0.5s ease" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 10, marginBottom: 32 }}>
              {[
                ...
                <div key={s.key} style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30, marginBottom: 8 }}>{s.label}</div>
              ...
              <div style={{ background: C.redSubtle, border: `1px solid rgba(220,38,38,0.15)`, borderRadius: 6, padding: "14px 16px" }}>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.red, marginBottom: 8 }}>WORK DAYS (AUTO)</div>
            ...
            <div style={{ marginBottom: 32 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                <span style={{
                  fontFamily: "'Bebas Neue', sans-serif", fontSize: 11, color: C.black, letterSpacing: "0.1em",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 10, marginBottom: 20 }}>
                {[
                  ...
                  <div key={r.key} style={{
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30, marginBottom: 8 }}>{r.label}</div>
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: C.white50, marginBottom: 12 }}>AVERAGE JOB TICKETS BY DEPARTMENT</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
                ...
                <div style={{ background: C.blackCard, borderRadius: 6, border: `1px solid rgba(220,38,38,0.15)`, overflow: "hidden" }}>
                  <div style={{ padding: "10px 14px", background: "rgba(220,38,38,0.06)", display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: C.red, letterSpacing: "0.1em" }}>PLUMBING</span>
                  </div>
                  <div style={{ padding: "12px 14px" }}>
                    <div style={{ marginBottom: 10 }}>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginBottom: 4 }}>Service Call Avg</div>
                      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                    ...
                    <div>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginBottom: 4 }}>Install Avg</div>
                      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                        <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 14, color: C.white30 }}>$</span>
                ...
                <div style={{ background: C.blackCard, borderRadius: 6, border: `1px solid rgba(59,130,246,0.15)`, overflow: "hidden" }}>
                  <div style={{ padding: "10px 14px", background: "rgba(59,130,246,0.06)", display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: C.blue, letterSpacing: "0.1em" }}>HVAC</span>
                  </div>
                  <div style={{ padding: "12px 14px" }}>
                    <div style={{ marginBottom: 10 }}>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginBottom: 4 }}>Service Call Avg</div>
                ...
                <div style={{ background: C.blackCard, borderRadius: 6, border: `1px solid rgba(245,158,11,0.15)`, overflow: "hidden" }}>
                  <div style={{ padding: "10px 14px", background: "rgba(245,158,11,0.06)", display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, color: C.amber, letterSpacing: "0.1em" }}>ELECTRICAL</span>
                  </div>
                  <div style={{ padding: "12px 14px" }}>
                    <div style={{ marginBottom: 10 }}>
                      <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 10, color: C.white30, marginBottom: 4 }}>Service Call Avg</div>
            ...
            <div style={{ marginBottom: 32 }}>
              ...
              {/* Department Split */}
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: C.red, marginBottom: 10 }}>DEPARTMENT SPLIT</div>
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: C.amber, marginBottom: 10 }}>SEASONAL BILLABLE HOUR MULTIPLIERS</div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 6, marginBottom: 20 }}>
                {MONTH_KEYS.map(m => (
                  <div key={m} style={{
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, color: m === currentMonthKey ? C.red : C.white30, marginBottom: 4 }}>{m}</div>
                    ...
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 9, color: C.white15, marginTop: 2 }}>%</div>
                  </div>
                ))}
              </div>

              {/* Customer Acquisition */}
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: C.green, marginBottom: 10 }}>CUSTOMER ACQUISITION</div>
                  ...
                  <div key={cat.key} className="jcard" style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                      <div>
                        ...
                        <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white30, marginTop: 1 }}>{cat.desc}</div>
                      </div>
                      <span style={{
                        fontFamily: "'JetBrains Mono', monospace", fontSize: 10, fontWeight: 700,
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", marginTop: 8 }}>
                      {alert && <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, fontWeight: 600, color: bColor }}>⚠ {alert.msg}</span>}
                      <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white15, marginLeft: "auto" }}>
                ...
                {COST_CATEGORIES.filter(c => c.layer === 1).map((cat, i) => {
                  ...
                  return (
                    <div key={cat.key} className="jcard" style={{
                      ...
                      {alert && <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, fontWeight: 600, color: C.amber, display: "block", marginTop: 6 }}>⚠ {alert.msg}</span>}
                      <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 11, color: C.white15, display: "block", marginTop: 4 }}>
                        Updated {lastUpdated[cat.key]}d ago
                      </span>
                    </div>
                  );
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{ textAlign: "center" }}>
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>{t.label}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 24 }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: C.white30 }}>{s.label}</div>
                  ...
                  return (
                    <div key={pct}>
                      <div style={{
                        ...
                        fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: C.white15, width: 40, textAlign: "right",
                      }}>${Math.round(val)}</div>
                      <div style={{
                  ...
                  {[...HISTORICAL_RATES, { month: "Apr '26", rate: trueHourlyRate, costs: totalCosts, current: true }].map((h, i) => {
                    ...
                    return (
                      <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", flex: 1, gap: 6 }}>
                        ...
                        <span style={{
                          fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: h.current ? 700 : 500,
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
                    <div>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", color: C.white30 }}>NEW TRUE HOURLY RATE</div>
                    </div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, color: C.white15, letterSpacing: "0.12em" }}>
            JT PLUMBING HEATING & AIR
          </span>
        </div>
        <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: C.white08 }}>
          CoDB Rate Engine v1.0
        </span>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: 9, color: C.white08, letterSpacing: "0.1em" }}>POWERED BY</span>
          <img src="data:image/png;base64," alt="TS" style={{ width: 20, height: 20, borderRadius: 3 }} />
          <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 14, color: C.white15 }}>
            TRADE<span style={{ color: C.red }}>SAVANT</span><span style={{ fontSize: 10, color: C.white08 }}>.AI</span>
          </span>
        </div>
      </div>
    </div>
